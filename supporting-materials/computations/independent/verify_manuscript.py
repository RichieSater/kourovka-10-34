...
required=[
 ...
 'recorded seed $1034$','no explicit random witness search','positions $45,46$',
 'unique-order stability argument','If $k=1$','Tikhonenko--Tyutyanov \\cite{TT2010}',
 'Zenkov had announced a negative','\\cite{Zenkov1997}',
 'of the theorem, not priority for the conclusion',
 'five separately auditable layers',
 'each closure is assigned a','SHA-256 fingerprint derived',
 'every required closure appears exactly once',
 'attached to one such closure',
 'three independent procedures enumerate the relevant overgroups',
 'any disagreement causes','verification to fail',
 ...
 'settled by the lower-range certificate \\texttt{Sp43}',
 ...
 'positive-base Zsigmondy exception occurs',
 'seven distinct exception records',
]
